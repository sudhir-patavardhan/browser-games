...
| [Drift](drift/index.html) | A bright, sunny top-down endless drifting game. An asphalt road that keeps throwing tighter, more frequent curves — drift through them with proper velocity/heading/grip physics, and hold the **handbrake** for big cinematic slides (with a small speed penalty). Longer, wider drifts grow a **combo multiplier**; poor driving bleeds speed and spins you out. Yellow tyre smoke, fading skid marks, procedural engine/skid audio, and local best score. **Mobile-first:** tap the left/right screen halves to steer and a big handbrake button; desktop uses ←/→ or A/D and Space. | Open `drift/index.html` in any browser |
