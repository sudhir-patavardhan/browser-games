...
| Game | Description | Play |
|---|---|---|
| [Sync](sync/index.html) | The empathic-accuracy duel. Ten cards, each with two columns beside the options: what **you** would pick, and what **they** would. Tap one in each and the card advances itself; a tap-to-edit recap is the lock-in. Then everything lands on **one page**: a ten-square scoreboard for **Similarity** (how alike your answers are) and each player's **Insight** (how well they read the other), the asymmetry when one of you reads the other better, the best moment and biggest miss, and all ten questions side by side with both answers and both guesses. Question packs for new pairs, couples, friends, family and coworkers. | [kreeda.games/sync](https://kreeda.games/sync/) |
| [Windows](windows/index.html) | A playable Johari Window. From forty trait words, each player picks six for themselves and six for the other — then both windows open on **one page**, words and all: **Open** (you both see it), **Hidden** (you claimed it, they don't see it), **Blind spot** (they see it, you didn't say it), Unknown (room to find out). Under them, the mirror moments (words you picked for each other, words you both claimed) and three things to ask. | [kreeda.games/windows](https://kreeda.games/windows/) |
